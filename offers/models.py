...
class Offer(models.Model):
    ...
    lodger_desired_sex = models.CharField(max_length=2, choices=SEX)
    sex_of_living_lodgers = models.CharField(max_length=2, choices=SEX_HOUSE)
    ...
    аverage_utility_bill = models.PositiveSmallIntegerField(null=True, blank=True)
    ...
    photo_1 = models.ImageField(upload_to='photos/house_offers', max_length=254, null=True, blank=True)
    photo_2 = models.ImageField(upload_to='photos/house_offers', max_length=254, null=True, blank=True)
    photo_3 = models.ImageField(upload_to='photos/house_offers', max_length=254, null=True, blank=True)
    photo_4 = models.ImageField(upload_to='photos/house_offers', max_length=254, null=True, blank=True)
